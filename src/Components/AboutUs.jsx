  ...
  return (
    <>
        ...
        <div class="banner-area pb-100">
            <div class="bg-img bg-padding-2" style={{backgroundImage:"url(assets/images/bg/bg-2.png)"}}>
                <div class="container">
        ...
        <div class="funfact-area bg-img pt-100 pb-70" style={{backgroundImage:"url(assets/images/bg/bg-4.png)"}}>
            <div class="container">
                <div class="row">
