(function ($) {
    ...
    var sliderActiveTwo = new window.Swiper('.product-slider-active-1', {
        loop: true,
        spaceBetween: 30,
        navigation: {
    ...
    // Brand logo active
    var sliderActiveThree = new window.Swiper('.brand-logo-active', {
        loop: true,
        spaceBetween: 20,
        breakpoints: {
            320: {
    ...
    var sliderActiveFour = new window.Swiper('.category-slider-active', {
        loop: true,
        spaceBetween: 43,
        breakpoints: {
            320: {
    ...
    var sliderActiveFive = new window.Swiper('.category-slider-active-2', {
        loop: true,
        spaceBetween: 30,
        slidesPerView: 6,
        breakpoints: {
    ...
    var sliderActiveSix = new window.Swiper('.product-slider-active-2', {
        loop: true,
        spaceBetween: 30,
        breakpoints: {
            320: {
    ...
    -----------------------------------------*/
    var productDetailsSmallOne = new window.Swiper('.product-details-small-img-slider-1', {
        loop: false,
        spaceBetween: 12,
        slidesPerView: 4,
        direction: 'vertical',
    ...
    -----------------------------------------*/
    var productDetailsBigThree = new window.Swiper('.product-details-big-img-slider-1', {
        autoplay: false,
        delay: 5000,
        slidesPerView: 1,
        loop: false,
    ...
    -----------------------------------------*/ 
    var productDetailsSmallTwo = new window.Swiper('.product-details-small-img-slider-2', {
        loop: false,
        spaceBetween: 20,
        slidesPerView: 4,
        navigation: {
    ...
    -----------------------------------------*/
    var productDetailsBigTwo = new window.Swiper('.product-details-big-img-slider-2', {
        autoplay: false,
        delay: 5000,
        slidesPerView: 1,
        loop: false,
